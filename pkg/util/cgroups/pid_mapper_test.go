...
func TestCgroupProcsPidMapper(t *testing.T) {
	...
	cgFooV1.pidMapper = &cgroupProcsPidMapper{
		...
		cgroupProcsFilePathBuilder: func(relativeCgrouPath string) string {
			return filepath.Join(cfs.rootPath, defaultBaseController, relativeCgrouPath, cgroupProcsFile)
		},
	}
	...
	cgFooV2.pidMapper = &cgroupProcsPidMapper{
		fr: cfs,
		cgroupProcsFilePathBuilder: func(relativeCgrouPath string) string {
			return filepath.Join(cfs.rootPath, "", relativeCgrouPath, cgroupProcsFile)
		},
	}
