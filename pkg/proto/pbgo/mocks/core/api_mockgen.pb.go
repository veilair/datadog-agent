...
func (m *MockAgentSecureClient) GetConfigUpdates(ctx context.Context, in *core.SubscribeConfigRequest, opts ...grpc.CallOption) (core.AgentSecure_GetConfigUpdatesClient, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(core.AgentSecure_GetConfigUpdatesClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAgentSecureClient) GetConfigs(ctx context.Context, in *core.GetConfigsRequest, opts ...grpc.CallOption) (*core.GetConfigsResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*core.GetConfigsResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Recv mocks base method.
func (m *MockAgentSecure_GetConfigUpdatesClient) Recv() (*core.ConfigResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Recv")
	ret0, _ := ret[0].(*core.ConfigResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetConfigUpdates mocks base method.
func (m *MockAgentSecureServer) GetConfigUpdates(arg0 *core.SubscribeConfigRequest, arg1 core.AgentSecure_GetConfigUpdatesServer) error {
	m.ctrl.T.Helper()
...
// GetConfigs mocks base method.
func (m *MockAgentSecureServer) GetConfigs(arg0 context.Context, arg1 *core.GetConfigsRequest) (*core.GetConfigsResponse, error) {
	m.ctrl.T.Helper()
...
// Send mocks base method.
func (m *MockAgentSecure_GetConfigUpdatesServer) Send(arg0 *core.ConfigResponse) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Send", arg0)
	ret0, _ := ret[0].(error)
	return ret0
